...
.submitAplyDisable{ background-color:#d9e4ea;color:#333;}
/*下拉选择*/
    ...
    <div class="main">
        ...
        <div class="content">
        	...
        	<ul>
                ...
                <li>
                	<p><i>*</i><span>借款金额(万元)：</span></p>
                    <input type="tel" name="fdBorrowAmount" required value="" placeholder="请填写">
                </li>
                <li class="bd_btm_c8">
                	<p><i>*</i><span>借款期限(月)：</span></p>
                    <input type="tel" name="fdBorrowTerm" required value="" placeholder="请填写">
                </li>
            </ul>
        </div>
        <div class="content">
